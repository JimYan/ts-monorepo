...
let M1Service = class M1Service {
    onModuleInit() {
        return __awaiter(this, void 0, void 0, function* () {
            let extra = {};
            const url = this.url ? this.url : yield (0, service_1.getServiceByPGname)("mwp.m1");
            if (!url) {
            ...
            const BookServiceClient = microservices_1.ClientProxyFactory.create({
                ...
                options: Object.assign({ package: "mwp.m1", url: url, protoPath: (0, path_1.join)(__dirname, "../proto/mwp/m1/mwp_m1_book.proto") }, extra),
            });
            const HeroesServiceClient = microservices_1.ClientProxyFactory.create({
                transport: microservices_1.Transport.GRPC,
                options: Object.assign({ package: "mwp.m1", url: url, protoPath: (0, path_1.join)(__dirname, "../proto/mwp/m1/mwp_m1_hero.proto") }, extra),
            });
